   ...
   <div class="content-wrapper">
    <div class="container col-md-10 col-sm-12 col-lg-12 rounded-0 d-flex justify-content-between">
        <div class="col-md-8 col-sm-12" style="max-width:93vw">
            ...
            showError('post_img');
            if(count($posts)<1){
                echo "<p style='width:70vw;' class='p-2 bg-white border rounded text-center my-3 col-12 d-flex justify-content-center'>Follow Seseorang atau tambahkan Postingan Baru</p>";
            }
            ...
            <div class="warna card mt-4">
                <div class="card-title d-flex justify-content-between  align-items-center">
                    ...
                    <div class="dropdown" style="height:0px;">
                        <i class="menu" style="" id="option<?=$post['id']?>" data-bs-toggle="dropdown" aria-expanded="false"></i>
               ...
               <?php
                ...
                <div>
                    ...
                    <span style="font-size:small" class="text-muted">Dikirim</span> <?=show_time($post['created_at'])?> 
                </div>
                <?php
                    if($post['post_text']){
                ?>
        ...
        <div class="modal fade" id="likes<?=$post['id']?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <?php
                    if(count($likes)<1){
                ?>
                    <p>Saat ini,Tidak ada Menyukai</p>
                <?php
                    }
                foreach($likes as $f){
