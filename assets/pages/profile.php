...
?>
    <div class="container col-md-9 col-sm-11 rounded-0">
            ...
            <div class="col-md-8 col-sm-11">
                    ...
                    <div class="d-flex gap-5 align-items-center">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#chatbox" onClick="popchat(<?=$profile['id'] ?>)"><i class="bi bi-chat-fill"></i> Pesan</a></li>
                ...
                <?php
                        ...
                        <div class="alert alert-danger" role="alert">
                            <i class="bi bi-x-octagon-fill"></i> @<?=$profile['username']?> Membelokirmu!
                        </div>
                <?php 
        ...
        <div class="alert alert-secondary text-center" role="alert">
            <i class="bi bi-x-octagon-fill"></i> Kamu Tidak Diizinkan Melihat Postingan !!
        </div>
        <?php
    ...
    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
        ...
        <div class="modal fade" id="postview<?=$post['id']?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="dropdown">
                    ...
                    <div style="font-size:small" class="text-muted">Dikirim <?=show_time($post['created_at'])?> </div> 
