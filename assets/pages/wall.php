...
?>
    <div class="container col-9 rounded-0 d-flex justify-content-between">
        <div class="col-8">
            ...
            showError('post_img');
            if(count($posts)<1) {
                echo "<h6 class='p-2 bg-white border rounded text-center'>Follow Seseorang Atau Tambahkan Post Baru </h6>";
            }
                ...
                &nbsp;&nbsp;<i class="bi bi-chat-left"></i><br>       
                </h4>

                <div>
                <span class="p-1 mx-2" data-bs-toggle="modal" data-bs-target="#likes<?=$post['id']?>"><?=count($likes)?> likes </span>
                <span class="p-1 mx-2" data-bs-toggle="modal" data-bs-target="#postview<?=$post['id']?>"><?=count($comments)?> komentar </span>
                </div>
                ...
                <input type="text" class="form-control rounded-0 border-0 comment-input" placeholder="ketikan sesuatu.." 
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body d-flex p-0">
                                ...
                                <div class="col-4 d-flex flex-column">
                                    ...
                                    if(count($comments)<1){
                                        ?>
                                        <p class="p-3 text-center my-2 nocomment">Tidak ada Komentar</a>
                                        <?php
                                    }
                ...
                <h6 class="text-muted p-2">You Can Follow Them</h6>
                    ...
                    <?php
                        ...
                        if(count($saran_follow)<1) {
                            echo "<h6 class='p-2 bg-white border rounded text-center'>Tidak Ada Saran User Untukmu </h6>";
                        }
                    ?>
                </div>
