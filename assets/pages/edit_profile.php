...
<div class="app overflow-auto">
    <div class="main-container">
        ...
        <div class="container col-md-10 col-sm-12 col-lg-12 rounded-0 d-flex justify-content-between">
            <div class="col-12 warna border rounded p-4 mt-4 shadow-sm">
                ...
                <form method="post" action="assets/php/actions.php?updateprofile" enctype="multipart/form-data">
                    ...
                    <?php
                        ...
                        {
                            ?>
                            <p class="text-success">Profile Berhasil di perbaharui! </p>
                    <?php
                        }
                    ?>
                    ...
                    <div class="d-flex">
                        <div class="form-floating mt-1 col-6 ">
                            <input type="text" name="first_name" value="<?=$user['first_name'] ?>" class="form-control rounded-0" placeholder="username">
